    ...
    public partial class RoomService : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (!int.TryParse(roomNumber, out roomNumberInt) ||
                !(roomNumberInt >= 100 && roomNumberInt <= 110) &&
                !(roomNumberInt >= 200 && roomNumberInt <= 210))
            {
                MessageBox.Show("Please enter a valid room number between 100-110 or 200-210.");
                return;
            }
        ...
        {
            if (File.Exists("10.html"))
            {

                Process.Start("10.html");
            }
            else
            {
